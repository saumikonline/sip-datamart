package com.sc.sip.datamart.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.sc.sip.datamart.service.EmailAlreadyUsedException ||
            ex instanceof com.sc.sip.datamart.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.sc.sip.datamart.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.sc.sip.datamart");
    }
}
